...
import { TextQueryMethod } from "@task-manager/zitadel-api/zitadel/object/v2/object_pb";
import { CreateCallbackRequest, OIDCService } from "@task-manager/zitadel-api/zitadel/oidc/v2/oidc_service_pb";
...
import { CreateResponseRequest, SAMLService } from "@task-manager/zitadel-api/zitadel/saml/v2/saml_service_pb";
import { RequestChallenges } from "@task-manager/zitadel-api/zitadel/session/v2/challenge_pb";
import { Checks, SessionService } from "@task-manager/zitadel-api/zitadel/session/v2/session_service_pb";
...
import { SendEmailVerificationCodeSchema } from "@task-manager/zitadel-api/zitadel/user/v2/email_pb";
import type { RedirectURLsJson } from "@task-manager/zitadel-api/zitadel/user/v2/idp_pb";
import { NotificationType, SendPasswordResetLinkSchema } from "@task-manager/zitadel-api/zitadel/user/v2/password_pb";
import { SearchQuery, SearchQuerySchema } from "@task-manager/zitadel-api/zitadel/user/v2/query_pb";
import { SendInviteCodeSchema, User, UserState } from "@task-manager/zitadel-api/zitadel/user/v2/user_pb";
import {
	AddHumanUserRequest,
...
import { Client, create, Duration } from "@task-manager/zitadel-client";
import { makeReqCtx } from "@task-manager/zitadel-client/v2";
...
export async function resendInviteCode({ serviceUrl, userId }: { serviceUrl: string; userId: string }) {
	const userService: Client<typeof UserService> = await createServiceForHost(UserService, serviceUrl);
...
export async function setUserPassword({
	...
	if (!code) {
		...
		if (!(authmethods.authMethodTypes.length === 0) && user.state !== UserState.INITIAL) {
