import { IDPType } from "@task-manager/zitadel-api/zitadel/idp/v2/idp_pb";
import { IdentityProviderType } from "@task-manager/zitadel-api/zitadel/settings/v2/login_settings_pb";
