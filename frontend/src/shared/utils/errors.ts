...
export const parseUseQueryError = (error?: Error | null | AxiosError, customErrorHandle?: ErrorMap, takeMessageFromError?: boolean | number[], errorIfEmpty?: boolean) => {
	...
	return customErrorHandle?.[errorData.statusCode] || defaultErrorMap[error.response.status] || defaultErrorMap.unknown
}
