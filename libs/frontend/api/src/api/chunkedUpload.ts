...
export const uploadInit = async (params: UploadInitRequest) =>
	(await axiosInstance.post<UploadInitResponse>("/actions/upload/init", params.body)).data;

export type UploadWholeFileRequest = BaseRequest<{ transactionId: string }, Blob>;

export const uploadWholeFile = async (params: UploadWholeFileRequest) =>
	(
...
export const uploadChunk = async (params: UploadChunkRequest) => {
...
export const uploadVerify = async (params: UploadVerifyRequest) =>
	(
...
export const uploadComplete = async (params: UploadCompleteRequest) =>
	(
		await axiosInstance.post<UploadCompleteResponse>(
...
export const uploadStatus = async (params: UploadStatusRequest) =>
	(
...
export const uploadCancel = async (params: UploadCancelRequest) =>
