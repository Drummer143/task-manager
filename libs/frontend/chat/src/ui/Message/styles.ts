...
export const useStyles = createStyles(({ css }, { senderClickable, showUserInfo }: StyleProps) => {
	const wrapper = css`
		position: relative;
		...
		transition: background-color var(--ant-motion-duration-fast) var(--ant-motion-ease-out-circ);
